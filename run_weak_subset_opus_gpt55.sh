...
run_model "anthropic/claude-opus-4.7" "recognition_llm_openrouter_claude_opus47_weak_hint_ref.txt"
run_model "openai/gpt-5.5" "recognition_llm_openrouter_openai_gpt55_weak_hint_ref.txt"
