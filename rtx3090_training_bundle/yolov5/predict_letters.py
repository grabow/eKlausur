...
img_file = '/Users/wiggel/Python/eKlausurData/Temp/000111_page_16_box_1.png'
#model_path = '/Users/wiggel/Python/Emnist_Model01/letter_class_C_hg_6_epochs_data_aug.h5'
model_path = '/Users/wiggel/Python/Emnist_Model01/letter_class_C_hg_6_epochs_aug_data_no_zoom.h5'
...
def rescale_and_invert(image):
    img3 = ((255-np.array(image))/255.0)[:,:,0];
    return img3;


def predict_letter(img1, show=False):
    global model
    if model is None:
        model = load_model(model_path)
    img2 = resize(img1, img_size, img_size)
    img3 = rescale_and_invert(img2)
